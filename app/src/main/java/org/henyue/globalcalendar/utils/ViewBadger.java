...
public class ViewBadger extends TextView {
    ...
    public ViewBadger(Context context) {
        this(context, (AttributeSet) null, android.R.attr.textViewStyle);
    }

    public ViewBadger(Context context, AttributeSet attrs) {
     ...
     */
    public ViewBadger(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public ViewBadger(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public ViewBadger(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
    ...
    public void setSolidColor(int color) {
        this.setBadgeBackgroundColor(color);
